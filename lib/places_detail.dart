...
class PlaceDetailState extends State<PlaceDetailWidget> {
    ...
    if (isLoading) {
      ...
      bodyChild = Column(
        ...
        children: <Widget>[
          ...
          Expanded(child: buildPlaceDetailList(placeDetail),),
        ],
      );
    }
  ...
  ListView buildPlaceDetailList(PlaceDetails placeDetail) {
    ...
    if (placeDetail.types?.first != null) {
      list.add(
        Padding(
            padding: EdgeInsets.only(top: 4.0, left: 8.0, right: 8.0, bottom: 0.0),
            child: Text(
    ...
    if (placeDetail.openingHours != null) {
      ...
      list.add(
        Padding(
            padding: EdgeInsets.only(top: 0.0, left: 8.0, right: 8.0, bottom: 4.0),
            child: Text(
